                ...
                <div className="gap-[10px] grid grid-cols-[1fr_auto_1fr] max-[768px]:grid-cols-1">
                    <div>
                        <img
                            ...
                            alt={array3?.[1]?.title} className="w-full"
                    ...
                    <ul>
                        <li
                            className="border-[#13131366] last-of-type:border-0 pb-[10px] last-of-type:pb-0 border-b-[1px] border-solid">

                            {/* <h4 className="mb-[1px] font-normal text-[#5A5A5A] text-[22px] leading-[32px]">

                                {`${array3?.[2]?.authorDetails?.firstName} ${array3?.[2]?.authorDetails?.lastName}`}
                            </h4> */}

                            <Link href={`/news/${array3?.[2]?.slug}`} legacyBehavior>
                                <a className="font-normal text-[#131313] text-[22px] hover:underline no-underline leading-[26px]">
